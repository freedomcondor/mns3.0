...
def generate_3D_triangle_gate_xml(id, x, y, z, rx, ry, rz, payload=0, size_x=5.0, thickness=0.2, margin_x=None, margin_y=None):
    ...
    if margin_x != None and margin_y != None and margin_x > size_x and margin_y > d * 4 :
      ...
      '''.format(
        ...
        -thickness*0.5,     l,                 -d,
         thickness*0.5,     l,                 -d,
        -thickness*0.5,     margin_x*0.5,      -d,
         thickness*0.5,     margin_x*0.5,      -d,
        -thickness*0.5,     margin_x*0.5,      margin_y*0.5,
         thickness*0.5,     margin_x*0.5,      margin_y*0.5,
        -thickness*0.5,     0,                 margin_y*0.5,
         thickness*0.5,     0,                 margin_y*0.5,
        -thickness*0.5,     0,                 d*2,
         thickness*0.5,     0,                 d*2,
...
def generate3DdroneParameters() :
    dict = {
        ...
        "dangerzone_drone"     :"4.0",
        "deadzone_drone"       :"1.5",
        "dangerzone_aerial_obstacle"  :"4.0",
        "deadzone_aerial_obstacle"    :"1.5",
        "avoid_speed_scalar"   :"3",

        "driver_default_speed" :"0.5",
        "driver_slowdown_zone" :"3.0",
        "driver_stop_zone"     :"0.3",
