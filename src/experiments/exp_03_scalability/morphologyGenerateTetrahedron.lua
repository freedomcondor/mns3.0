...
function generate_tetrahedron(n_nodes, n_side, positionV3, orientationQ)
	...
	local tetrahedron_child = generate_tetrahedron(n_nodes_tetrahedron_minus_1, n_side-1, vector3(L/math.sqrt(3)*0.9, 0, 1.2*L*math.sqrt(2)/math.sqrt(3)), quaternion())
