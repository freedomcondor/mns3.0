...
DATADIR=@CMAKE_MNS_DATA_PATH@/exp_22_builderbot_scenario_2_large_simulation/$experiment_type/run_data
CODEDIR=$DATADIR/../code
TMPDIR=@CMAKE_BINARY_DIR@/threads
#THREADS_LOG_OUTPUT=`pwd`/threads_output.txt

#echo exp_22_builderbot_scenario_2_large_simulation start > $THREADS_LOG_OUTPUT # this is for run_single_threads to reset $THREADS_LOG_OUTPUT
