...
local function generateEye(L, positionV3, orientationQ, color)
	local node = {
		robotTypeS = "drone",
...
local function generateMouth(L, positionV3, orientationQ, color)
...
local function generateAngryFace(positionV3, orientationQ, color)
	local node = {
		robotTypeS = "drone",
		positionV3 = positionV3,
		orientationQ = orientationQ,
...
local function generateSmileFace(positionV3, orientationQ, color)
	local node = {
		robotTypeS = "drone",
		positionV3 = positionV3,
		orientationQ = orientationQ,
