...
function create_wheel(color, positionV3, orientationQ, d, n)
    local node = create_circle(color, positionV3, orientationQ, d, n)
	local th = math.pi / n
    table.insert(node.children, create_circle(color, vector3(2, 0, 0), quaternion(th, vector3(1,0,0)), d * 0.9, n))
    return node
end

function create_circle(color, positionV3, orientationQ, d, n)
...
function create_truck(th)
	...
	-- left back body
	local left_body, tail = create_complex_beam(3, L, thick,
	                               "blue",
	                               vector3(0, L * 0.75, 0),
	                               quaternion(math.pi, vector3(1, 0, 0)) * quaternion(math.pi, vector3(0, 0, 1))
	                              )

	local left_tail, tail_tail = create_complex_beam(1, L, thick,
	                               "blue",
	                               vector3(0, 0, thick),
	...
	-- right back body
	local right_body, tail = create_complex_beam(3, L, thick,
	                               "blue",
	                               vector3(0, -L * 0.75, 0),
	                               quaternion(math.pi, vector3(1, 0, 0)) * quaternion(math.pi, vector3(0, 0, 1))
	                              )

	local right_tail, tail_tail = create_complex_beam(1, L, thick,
	                               "blue",
	                               vector3(0, 0, thick),
	                               quaternion(math.pi, vector3(1, 0, 0))
	                              )
	...
	-- left front
	local left_front, tail = create_complex_beam(2, L * 1.2, L * 1,
	                                "red",
	                                vector3(L * 0.5, L, 0),
	...
	-- right front
	local right_front, tail = create_complex_beam(2, L * 1.2, L * 1,
	                                "red",
	                                vector3(L * 0.5, -L, 0),
	                                quaternion(math.pi, vector3(1, 0, 0)) * quaternion(math.pi/2, vector3(0, 1, 0))
	                                )
	...
	-- front bottom
	local front_bottom, tail = create_complex_beam(2, L, L * 1.2,
	                                "red",
	                                vector3(0, -L * 0.75, L * 1.7),
	                                quaternion(math.pi/2, vector3(0, 0, 1)) * quaternion(math.pi/2, vector3(1, 0, 0))
	                                )
	...
	-- front top
	local front_top, tail = create_complex_beam(2, L, L * 1.2,
	                                light_blue,
	                                vector3(0, 0, L * 1.7),
	                                quaternion()
	                                )
